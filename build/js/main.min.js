...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    if (coachesSliderContainer) {
      var nextButton = coachesSliderContainer.querySelector('.coaches__slider-btn--next');
      var prevButton = coachesSliderContainer.querySelector('.coaches__slider-btn--prev');
