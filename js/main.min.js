...
/* harmony import */ var _utils_init_tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/init-tabs */ "./js/utils/init-tabs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_utils_init_tabs__WEBPACK_IMPORTED_MODULE_3__["initTabs"])();
    var wrapperVideo = document.querySelector('[data-video]');
    var picture = wrapperVideo.querySelector('picture');
    var buttonVideo = document.querySelector('[data-video-button]');
    ...
    var coachesSliderContainer = document.querySelector('.coaches__slider-container');
    var coachesSliderWrapper = document.querySelector('.coaches__slider-wrapper');
    if (coachesSliderContainer) {
      var nextButton = coachesSliderWrapper.querySelector('.coaches__slider-btn--next');
      var prevButton = coachesSliderWrapper.querySelector('.coaches__slider-btn--prev');
      var slider = new Swiper(coachesSliderContainer, {
        slidesPerView: 1,
        spaceBetween: 0,
    ...
    var reviewsSliderContainer = document.querySelector('.reviews__slider-container');
    if (reviewsSliderContainer) {
      var _nextButton = reviewsSliderContainer.querySelector('.reviews__slider-btn--next');
      var _prevButton = reviewsSliderContainer.querySelector('.reviews__slider-btn--prev');
      var _slider = new Swiper(reviewsSliderContainer, {
        slidesPerView: 1,
        spaceBetween: 0,
        direction: 'horizontal',
        navigation: {
...
/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tabs */ "./js/utils/tabs.js");
